  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://mentoriaraiz-api.onrender.com/api/inscricao",
        {
          method: "POST",
      ...
      <main className="flex flex-col items-center pt-[18%] sm:pt-[0] bg-gradient-to-bl from-[#350e0e] via-[#630303] to-[#350e0e] min-h-screen text-white px-4">
        ...
        <ul className="w-full pl-5 mt-12 text-left">
          ...
          <li className="flex items-center gap-1.5 mb-2">
            <img className="w-[30px]" src="check.png" alt="" /> 3 encontros
            individuais mensais e 5 encontros mensais em grupo com Thalyta
            Eloah.
          </li>
          <li className="flex items-center gap-1.5 mb-2">
          ...
          <li className="flex items-center gap-1.5 mb-2">
            <img className="w-[30px]" src="check.png" alt="" /> Uma jornada de 3
        ...
        <div className="text-center">
          <h2 className="text-3xl text-yellow-600 font-semibold">
            Investimento
          </h2>
        ...
        <div className="pro-scale scale-[.9] mt-16 border-1 border-yellow-600 p-8 rounded-[6px] font-light text-center">
          <p>
            <span className="font-semibold">Promoção: </span>de<span className="font-medium line-through"> R$ 3.597</span> por <span className="font-medium"> R$ 2.997</span> para os <span className="text-[18px] font-medium"> 5 primeiros inscritos </span>
          </p>
          <p className="text-yellow-600 font-semibold text-[10px]">
            <span className="text-[12px]">Atenção:</span> promoção válida apenas
      ...
      >
        ...
        >
          <button
            ...
            className="absolute top-2 right-3 text-gray-700 text-2xl font-bold hover:text-red-600"
          >
            &times;
          </button>
          ...
          <div className="overflow-hidden relative h-auto">
            <div
              ...
              style={{
                transform:
                  tipo === "individual" ? "translateX(0%)" : "translateX(-50%)",
                width: "200%",
              }}
            >
              {/* Form Individual */}
              ...
              <div className="w-1/2 pl-4 overflow-hidden">
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="w-full bg-yellow-600 text-white p-2 mb-[100px] rounded"
                  >
                    Finalizar inscrição
                  </button>
                </form>
